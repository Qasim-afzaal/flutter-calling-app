...
const backgroundAudioCallLight = Color(0xFFF2F3F4);
const backgroundAudioCallDark = Color(0xFFC4C4C4);
const greycolor = Color(0xFFFAFAFB);
const darkIndigoColor = Color(0xFF8C81AA);
const lightgreycolor = Color(0xFFF1F1F5);
...
const darkBlackColor = Color(0xFF151624);
...
const personStatusColor = Color(0xffa39abb);
...
const lightgreyColor = Color(0xFFE0EBE9);
